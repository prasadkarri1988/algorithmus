 ...
 * @author prasad
 * 
 *         Task description An array A consisting of N integers is given.
 ...
 *         For example, the rotation of array A = [3, 8, 9, 7, 6] is [6, 3, 8,
 *         9, 7] (elements are shifted right by one index and 6 is moved to the
 *         first place).
 * 
